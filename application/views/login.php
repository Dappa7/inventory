...
<head>
	...
	<title>GearHub ID | Login</title>
	<link rel="shortcut icon" type="image/png/jpg" href="sb-admin/img/mylogo.png">
						...
						<div class="col-lg">
							<div class="p-5">
								<div class="text-center">
									...
									<?php endif ?>
									<img src="<?= base_url('sb-admin') ?>/img/logoo.png" class="h4 text-gray-900 mb-4">
									<h4 class="h4 text-gray-900 mb-4">GearHub Computer</h4>
								</div>
